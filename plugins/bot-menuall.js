...
await conn.reply(m.chat, '*𝗣𝗿𝗼𝘅𝗶𝗺𝗮𝗺𝗲𝗻𝘁𝗲 𝘀𝗲 𝗿𝗲𝗺𝗶𝘁𝗶𝗿𝗮 𝗲𝗹 𝗺𝗲𝗻𝘂.*', fkontak, { contextInfo:{ forwardingScore: 2022, isForwarded: true, externalAdReply: {title: '👋 Hola!!', body: saludo, sourceUrl: global.ig, thumbnailUrl: ppBot }}})
m.react('👹') 
